import { IonButtons,IonGrid, IonText, IonRow, IonCol, IonFooter, IonButton, IonContent, IonHeader, IonMenuButton, IonPage, IonTitle, IonToolbar, IonIcon } from '@ionic/react';
      ...
      <IonContent fullscreen>
        <IonHeader collapse="condense">
          ...
          <IonContent className="ion-padding">
            ...
            <IonFooter>
                <IonText><div className='page_number'>1</div></IonText>
                <IonToolbar>
                    <IonGrid>
                        <IonRow>
                            <IonCol>
