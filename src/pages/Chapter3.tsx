import { IonButtons,IonGrid, IonRow, IonCol, IonFooter, IonButton, IonContent, IonHeader, IonMenuButton, IonPage, IonTitle, IonToolbar, IonIcon, IonText } from '@ionic/react';
      ...
      <IonContent fullscreen>
        <IonHeader collapse="condense">
          ...
          <IonContent className="ion-padding">
            ...
            <IonFooter>
                <IonText><div className='page_number'>3</div></IonText>
                <IonToolbar>
                    <IonGrid>
                        <IonRow>
                            <IonCol>
